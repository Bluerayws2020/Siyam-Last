...
class RadiatorsItemAdapter  (private val list: List<GetContentList>, private val context: Context, private val onClickListener: OnClickListener) :
    RecyclerView.Adapter<RadiatorsItemAdapter.Holder>()  {
